...
{
	printf("%s\n", "sort başı");	fflush(stdout);		//uysdjhfgahksjdfhgsadhfghasgdfhlgasdfgasdgf
...
int sort_main(t_tab *str, int len)
{
	...
	printf("%s\n", "sort_main başı");	fflush(stdout);		//uysdjhfgahksjdfhgsadhfghasgdfhlgasdfgasdgf
...
void	sort_for_three(t_tab *str, int len)
{
	...
	str->size_a = ft_lstsize(str->a);
	printf("%s\n", "sort_for_three başı");	fflush(stdout);		//uysdjhfgahksjdfhgsadhfghasgdfhlgasdfgasdgf
	...
	if (str->size_a == 3 && len == 3)
	{
		...
		if(index == 0)
		{
			printf("%s\n", "index 0");	fflush(stdout);		//uysdjhfgahksjdfhgsadhfghasgdfhlgasdfgasdgf
		...
		{
			printf("%s\n", "index 1");	fflush(stdout);		//uysdjhfgahksjdfhgsadhfghasgdfhlgasdfgasdgf
		...
		{
			printf("%s\n", "index 2");	fflush(stdout);		//uysdjhfgahksjdfhgsadhfghasgdfhlgasdfgasdgf
	...
	else if (len == 3)
	{
		...
		{
			if (len == 3 && str->a->content > str->a->next->content && str->a->next->next->content)
				sa(str);
...
int	check_sorted_a(t_tab *str, int len)
{
	int i;
	t_list *tmp;
	printf("%s\n", "check_sorted_a");    fflush(stdout); //sahdfglksadjgfjahsdfjhsdhfjasdjfhsdf
...
int	check_sorted_b(t_tab *str, int len)
{
	...
	printf("%s\n", "check_sorted_b");    fflush(stdout); //sahdfglksadjgfjahsdfjhsdhfjasdjfhsdf
