...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/19 18:07:38 by agurses           #+#    #+#             */
/*   Updated: 2025/03/19 18:30:53 by agurses          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	sort_main(t_tab *str, int len, int halfa, int len2)
{
	...
	while (len2 / 2 + len2 % 2 != str->size_a && count--)
		rra(str);
	return (sort_main(str, (len2 / 2 + len2 % 2), halfa, len2)
		&& sort_b(str, (len2 / 2), 0, 0));
}
